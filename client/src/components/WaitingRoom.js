  ...
  return (
    <div className="waiting-room">
      ...
      {/* Same GameTabStrip used once real Top-8 markets exist, so switching
          ...
          Bracket Tracker: tapping "Top 8" shows the live bracket, tapping any
          earlier round shows that round's results — so reaching Top 8 doesn't
          bury how a player got there (e.g. their Round of 16 result) behind a
